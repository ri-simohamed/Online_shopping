	...
	<div class="container">
		<div class="card w-50 ma-outo my-3">
			...
			<div class="whysing">
				...
				%>
				<h2 style="color: red;">Your Eamil Incorrect!</h2>
				<%
				}
				%>
			...
			<form action="forgotpasswordAction" method="post">
				...
				<div class="form-group">
					...
					<label>Email</label> <input type="email" class="form-control"
						name="email" placeholder="Enter Email..." required> <label>New Password</label>
					...
					<h1 style="font-size: 20px; text-align: right;"><a href="login.jsp">Login</a></h1>
				</div>
			</form>
		</div>
	</div>
